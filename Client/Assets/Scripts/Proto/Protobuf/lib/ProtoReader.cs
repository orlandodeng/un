        ...
        public uint ReadUInt32()
        {
            switch (wireType)
            {
                ...
                case WireType.Fixed32:
                    ...
                    position += 4;
                    available -= 4;
					uint t1 = (uint)ioBuffer[ioIndex++];
					uint t2 = (uint)ioBuffer[ioIndex++];
					uint t3 = (uint)ioBuffer[ioIndex++];
					uint t4 = (uint)ioBuffer[ioIndex++];
                    return (t1)
                        | ((t2) << 8)
                        | ((t3) << 16)
                        | ((t4) << 24);
        ...
        public int ReadInt32()
        {
            switch (wireType)
            {
                ...
                case WireType.Fixed32:
                    ...
                    position += 4;
                    available -= 4;
				int t1 = (int)ioBuffer[ioIndex++];
				int t2 = (int)ioBuffer[ioIndex++];
				int t3 = (int)ioBuffer[ioIndex++];
				int t4 = (int)ioBuffer[ioIndex++];
                    return (t1)
                        | ((t2) << 8)
                        | ((t3) << 16)
                        | ((t4) << 24);
        ...
        public long ReadInt64()
        {
            ...
            switch (wireType)
            {
                ...
                case WireType.Fixed64:
                    ...
                    position += 8;
                    available -= 8;
					t1 = (long)ioBuffer[ioIndex++];
					t2 = (long)ioBuffer[ioIndex++];
					t3 = (long)ioBuffer[ioIndex++];
					t4 = (long)ioBuffer[ioIndex++];
					t5 = (long)ioBuffer[ioIndex++];
					t6 = (long)ioBuffer[ioIndex++];
					t7 = (long)ioBuffer[ioIndex++];
					t8 = (long)ioBuffer[ioIndex++];
        ...
        public ulong ReadUInt64()
        {
            switch (wireType)
            {
                ...
                case WireType.Fixed64:
                    ...
                    position += 8;
                    available -= 8;
					ulong t1 = (ulong)ioBuffer[ioIndex++];
					ulong t2 = (ulong)ioBuffer[ioIndex++];
					ulong t3 = (ulong)ioBuffer[ioIndex++];
					ulong t4 = (ulong)ioBuffer[ioIndex++];
					ulong t5 = (ulong)ioBuffer[ioIndex++];
					ulong t6 = (ulong)ioBuffer[ioIndex++];
					ulong t7 = (ulong)ioBuffer[ioIndex++];
					ulong t8 = (ulong)ioBuffer[ioIndex++];
